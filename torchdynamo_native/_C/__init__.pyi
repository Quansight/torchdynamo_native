...
class Function:
    ...
    def set_placeholder(self, i: int) -> Value: ...
    def set_output_from_refs(self, outputs: List[Value]) -> List[Value]: ...
    def set_output_from_ref(self, output: Value) -> Value: ...

    def add_call(self, opname: str, args: List[Value]) -> Value: ...
    ...
    def build_load_for_scalar(self, scalar: Value) -> Value: ...

    def build_scalar_int(self, literal: Value) -> Value: ...
    def build_scalar_float(self, literal: Value) -> Value: ...
    def build_scalar_complex(self, real: Value, img: Value) -> Value: ...

    def build_array_int(self, elements: List[Value]) -> Value: ...
    def build_array_scalar(self, elements: List[Value]) -> Value: ...
